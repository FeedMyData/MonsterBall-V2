...
Shader "ZFS Shaders/ZFS_3D_Pro" {
    Properties {
        ...
        _Goal ("Goal", Color) = (1,1,1,1)
        [MaterialToggle] _Switch_goal ("Switch_goal", Float ) = 1
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform float4 _Goal;
            uniform fixed _Switch_goal;
            struct VertexInput {
...
////// Emissive:
                ...
                float3 emissive = lerp( (lerp( (_Solid_Color.rgb*node_1665), _Gradient_Color_var.rgb, _Gradient_Or_Solid_Color )*_Brightness), _Goal.rgb, _Switch_goal );
